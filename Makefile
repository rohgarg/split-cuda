...
TARGET_PRELOAD_LIB_OBJS=upper-half-wrappers.o upper-half-cuda-wrappers.o mem-ckpt.o utils.o
...
${KERNEL_LOADER_BIN}: ${KERNEL_LOADER_OBJS}
	nvcc -Xlinker -Ttext-segment -Xlinker 0x800000 --cudart shared $^ -o $@ -lcuda -ldl
